...
class Emoji {
  ...
  Emoji copyWith({List<Emoji> diversityChildren}) {
    return Emoji(name, text, category,
        diversityChildren: diversityChildren ?? this.diversityChildren,
        limitRangeAndroid: limitRangeAndroid,
        limitRangeIOS: limitRangeIOS);
  }
}
